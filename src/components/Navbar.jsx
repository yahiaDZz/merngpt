      ...
      <div className="flex justify-between p-2">
        ...
        <div className="space-x-4">
          <button
            ...
            className="hover:scale-110 transition ease-in-out duration-400 uppercase rounded-lg bg-blue-400 px-4 py-2 text-black font-bold"
          >
            Login
          </button>
          <button
            onClick={() => navigate("/signup")}
            className="hover:scale-110 transition ease-in-out duration-400 uppercase rounded-lg bg-gray-700 px-4 py-2 text-white font-bold"
          >
            Signup
          </button>
        </div>
